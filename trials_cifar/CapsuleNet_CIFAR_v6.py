...
def main():
    ...
    conv1_filters = hp.HParam('conv1_filters', hp.Discrete([64]))
    ...
    conv2_filters = hp.HParam('conv2_filters', hp.Discrete([64]))
    ...
    conv3_filters = hp.HParam('conv3_filters', hp.Discrete([128]))
    ...
    conv4_filters = hp.HParam('conv4_filters', hp.Discrete([128]))
    ...
    tf.keras.models.save_model(model, 'caps_net_cifar_v6.h5')
