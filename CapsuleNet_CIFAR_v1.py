...
def caps_net(run_dir, hparams, it_train, test_data, test_labels):
    with tf.summary.create_file_writer(run_dir).as_default():
        ...
        conv1 = layers.Conv2D(filters=hparams['conv1_filters'], kernel_size=hparams['conv1_kernel_size'],
                             ...
                             kernel_initializer='he_uniform', kernel_regularizer=l2(0.0001))(x)
        ...
        conv2 = layers.Conv2D(filters=hparams['conv2_filters'], kernel_size=hparams['conv2_kernel_size'],
                             ...
                             kernel_initializer='he_uniform', kernel_regularizer=l2(0.0001))(conv1)
        ...
        conv3 = layers.Conv2D(filters=hparams['conv3_filters'], kernel_size=hparams['conv3_kernel_size'],
                             ...
                             kernel_initializer='he_uniform', kernel_regularizer=l2(0.0001))(conv2)
        ...
        conv4 = layers.Conv2D(filters=hparams['conv4_filters'], kernel_size=hparams['conv4_kernel_size'],
                             ...
                             kernel_initializer='he_uniform', kernel_regularizer=l2(0.0001))(conv3)
        ...
        model.fit(it_train, epochs=100, batch_size=64, verbose=1, workers=48,
...
def main():
    ...
    model = hp_tuning(hp_list, it_train, test_data, test_labels)

    tf.keras.models.save_model(model, 'caps_net_cifar_v11.h5')
