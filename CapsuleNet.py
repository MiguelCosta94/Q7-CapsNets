...
def main():
    ...
    conv1_filters = hp.HParam('conv_filters', hp.Discrete([4, 8, 16]))
    ...
    pcaps_num_capsule = hp.HParam('pcaps_num_capsule', hp.Discrete([4, 8, 16]))
    ...
    caps1_dim_capsule = hp.HParam('caps1_dim_capsule', hp.Discrete([4, 8, 16]))
    ...
    tf.keras.models.save_model(model, 'caps_net.h5')
