...
def caps_net(run_dir, hparams, train_data, train_labels, test_data, test_labels):
    with tf.summary.create_file_writer(run_dir).as_default():
        ...
        pcaps = layers.Dropout(0.2)(pcaps)
        ...
        model.fit(x=train_data, y=train_labels, epochs=20, batch_size=32, verbose=1, workers=48,
...
def main():
    ...
    tf.keras.models.save_model(model, 'caps_net_mnist_v5.h5')
