...
int8_t conv2_wt[CONV2_KERNEL_SIZE * CONV2_KERNEL_SIZE * CONV2_CH_DIM * CONV2_NUM_FILTERS] = CONV2D_1_WT;
int8_t conv2_bias[CONV2_NUM_FILTERS] = CONV2D_1_BIAS;

int8_t conv3_wt[CONV3_KERNEL_SIZE * CONV3_KERNEL_SIZE * CONV3_CH_DIM * CONV3_NUM_FILTERS] = CONV2D_2_WT;
int8_t conv3_bias[CONV3_NUM_FILTERS] = CONV2D_2_BIAS;

int8_t conv4_wt[CONV4_KERNEL_SIZE * CONV4_KERNEL_SIZE * CONV4_CH_DIM * CONV4_NUM_FILTERS] = CONV2D_3_WT;
int8_t conv4_bias[CONV4_NUM_FILTERS] = CONV2D_3_BIAS;
...
int8_t out_buffer2[CONV1_OUT_DIM * CONV1_OUT_DIM * CONV1_NUM_FILTERS];
int8_t buffer_aux[CONV1_OUT_DIM * CONV1_OUT_DIM * CONV1_NUM_FILTERS];
...
int8_t run_ann(void *arg)
{
	...
	pulp_nn_conv_Ho_parallel_int8(out_buffer1, CONV2_IN_DIM, CONV2_IN_DIM, CONV2_CH_DIM, conv2_wt, CONV2_NUM_FILTERS, CONV2_KERNEL_SIZE, 
						CONV2_KERNEL_SIZE, CONV2_PADDING, CONV2_PADDING, CONV2_PADDING, CONV2_PADDING, CONV2_STRIDE, CONV2_STRIDE,
						conv2_bias, CONV2_BIAS_LSHIFT, CONV2_OUT_RSHIFT, 1, out_buffer2, CONV2_OUT_DIM, CONV2_OUT_DIM, NULL, NULL,
						buffer_aux, 1, 0, NULL);

	// Layer 3: Conv2D layer
	pulp_nn_conv_Ho_parallel_int8(out_buffer2, CONV3_IN_DIM, CONV3_IN_DIM, CONV3_CH_DIM, conv3_wt, CONV3_NUM_FILTERS, CONV3_KERNEL_SIZE, 
						CONV3_KERNEL_SIZE, CONV3_PADDING, CONV3_PADDING, CONV3_PADDING, CONV3_PADDING, CONV3_STRIDE, CONV3_STRIDE,
						conv3_bias, CONV3_BIAS_LSHIFT, CONV3_OUT_RSHIFT, 1, out_buffer1, CONV3_OUT_DIM, CONV3_OUT_DIM, NULL, NULL,
						buffer_aux, 1, 0, NULL);

	// Layer 4: Conv2D layer
	pulp_nn_conv_Ho_parallel_int8(out_buffer1, CONV4_IN_DIM, CONV4_IN_DIM, CONV4_CH_DIM, conv4_wt, CONV4_NUM_FILTERS, CONV4_KERNEL_SIZE, 
						CONV4_KERNEL_SIZE, CONV4_PADDING, CONV4_PADDING, CONV4_PADDING, CONV4_PADDING, CONV4_STRIDE, CONV4_STRIDE,
						conv4_bias, CONV4_BIAS_LSHIFT, CONV4_OUT_RSHIFT, 1, out_buffer2, CONV4_OUT_DIM, CONV4_OUT_DIM, NULL, NULL,
						buffer_aux, 1, 0, NULL);
	
	// Layer 5: Conv2D layer with `squash` activation
	primary_capsule_layer_Ho_parallel_q7(out_buffer2, PCAP_IN_DIM, PCAP_IN_DIM, PCAP_CH_DIM, pcap_wt, PCAP_NUM_CAP, PCAP_DIM_CAP,
								...
								out_buffer1, PCAP_OUT_DIM, PCAP_OUT_DIM, buffer_aux);
	
	// Layer 6: Capsule layer. Routing algorithm works here
	capsule_layer_q7(out_buffer1, CAP_NUM_CAP, CAP_DIM_CAP, CAP_INPUT_NUM_CAP, CAP_INPUT_DIM_CAP, CAP_NUM_ROUT, cap_wt,
					CAP_IN_HAT_RSHIFT, cap_out_rshifts, b_inst_rshifts, b_new_rshifts, cap_squash_in_qn, cap_squash_out_qn,
					out_buffer2, buffer_input_hat, buffer_b, buffer_c, buffer_aux);
...
void cluster_delegate(void *arg)
{
	...
	for(uint16_t i=0; i<DATASET_SIZE; i++) {
		...
		for(uint16_t j=0; j<CAP_NUM_CAP; j++){
			if(out_buffer1[j] > out_buffer1[prediction]){
				prediction = j;
			}
		}
