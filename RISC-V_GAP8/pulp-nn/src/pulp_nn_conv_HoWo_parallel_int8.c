...
void __attribute__ ((noinline)) pulp_nn_conv_HoWo_parallel_int8(
  ...
  int8_t *pOut = pOutBuffer + (start_pixel * ch_out * dim_out_x) + (section * ch_out * dim_out_x_r);
